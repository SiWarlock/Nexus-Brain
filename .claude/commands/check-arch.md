...
1. Read the lookup table in `core/CLAUDE.md` (top section, near "Lookup table — where to find canonical info").
...
Recommendation: add a row to the core/CLAUDE.md lookup table:
| <topic> | <file> | §<section> |
```
